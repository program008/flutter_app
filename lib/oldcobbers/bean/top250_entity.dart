class Top250Entity {
	...
	Top250Entity.fromJson(Map<String, dynamic> json) {
		...
		if (json['subjects'] != null) {
			subjects = new List<Top250Subject>();(json['subjects'] as List).forEach((v) { subjects.add(new Top250Subject.fromJson(v)); });
		}
		count = json['count'];
		start = json['start'];
		title = json['title'];
...
class Top250Subject {
	...
	Top250Subject({this.images, this.originalTitle, this.year, this.directors, this.rating, this.alt, this.title, this.collectCount, this.hasVideo, this.pubdates, this.casts, this.subtype, this.genres, this.durations, this.mainlandPubdate, this.id});

	Top250Subject.fromJson(Map<String, dynamic> json) {
		images = json['images'] != null ? new Top250SubjectsImages.fromJson(json['images']) : null;
		originalTitle = json['original_title'];
		year = json['year'];
		if (json['directors'] != null) {
			directors = new List<Top250SubjectsDirector>();(json['directors'] as List).forEach((v) { directors.add(new Top250SubjectsDirector.fromJson(v)); });
		}
		rating = json['rating'] != null ? new Top250SubjectsRating.fromJson(json['rating']) : null;
		alt = json['alt'];
		title = json['title'];
		...
		if (json['casts'] != null) {
			casts = new List<Top250SubjectsCast>();(json['casts'] as List).forEach((v) { casts.add(new Top250SubjectsCast.fromJson(v)); });
		}
...
class Top250SubjectsDirector {
	...
	Top250SubjectsDirector({this.name, this.alt, this.id, this.avatars, this.nameEn});

	Top250SubjectsDirector.fromJson(Map<String, dynamic> json) {
		name = json['name'];
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new Top250SubjectsDirectorsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
...
class Top250SubjectsRating {
	...
	Top250SubjectsRating({this.average, this.min, this.max, this.stars});
...
class Top250SubjectsCast {
	...
	Top250SubjectsCast.fromJson(Map<String, dynamic> json) {
		...
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new Top250SubjectsCastsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
